...
function get_yearly_vdsfiles_local(opts,cb){
    var hwytypes = ['ML|CH|HV|CD|FF|FR|OR']
    if(opts.hwytypes !== undefined){
        console.log('overriding default highway types')
        console.log('was',hwytypes,'changed to:',opts.hwytypes)
        hwytypes = opts.hwytypes
    }
